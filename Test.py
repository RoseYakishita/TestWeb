...
class SignupTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.driver.get("http://127.0.0.1:8000/Register")  # Thay đổi URL tới trang đăng ký
    ...
    def test_signup_with_valid_info(self):
        self.signup("testuser01", "test@gmail.com", "testpassword", "testpassword", expected_url="http://127.0.0.1:8000/", expected_message="Thành công: Thử nghiệm đăng ký thành công!")
    # #trường hợp email đã tồn tại
    def test_signup_with_existing_email(self):
        self.signup("existinguser", "test@gmail.com", "testpassword", "testpassword", expected_url="http://127.0.0.1:8000/Register", expected_message="Thất bại: Email đã được sử dụng!")
    # #trường hợp mật khẩu không khớp
    def test_signup_with_mismatched_passwords(self):
        self.signup("testuser02", "newuser@gmail.com", "password1", "password2", expected_url="http://127.0.0.1:8000/Register", expected_message="Thất bại: Mật khẩu không khớp!")

    def signup(self, username, email, password1, password2, expected_url, expected_message):
        driver = self.driver
...
class SigninTestCase(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Edge()  # Sử dụng WebDriver của trình duyệt, bạn có thể thay đổi thành trình duyệt khác
        self.driver.get("http://127.0.0.1:8000/Login")  # Thay đổi URL tới trang đăng ký
    ...
    def test_signin_valid(self):  
        self.signin("test@gmail.com", "testpassword", expected_url="http://127.0.0.1:8000/user_list", expected_message="Thành công: Thử nghiệm đăng nhập thành công!")
    # Kiểm tra đăng nhập với mật khẩu không đúng
    def test_signin_with_incorrect_password(self):
        self.signin("test@gmail.com", "incorrectpassword", expected_url="http://127.0.0.1:8000/Login", expected_message="Thất bại: Mật khẩu không đúng!")
    # Kiểm tra đăng nhập với email không tồn tại
    def test_signin_with_invalid_email(self):
        self.signin("nonexistent@gmail.com", "testpassword", expected_url="http://127.0.0.1:8000/Login", expected_message="Thất bại: Email không tồn tại!")
